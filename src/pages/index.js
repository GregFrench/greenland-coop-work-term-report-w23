  ...
  return (
    <main style={pageStyles}>
      ...
      <div id="content">
        ...
        <p>As a software developer, the most significant task I had throughout the term was building out the Software Monitoring and Alerts System (SMAS). This is an internal tool that monitors various aspects of Greenland&lsquo;s existing EC2 instances and sends alerts to employees over email and SMS if it notices an existing issue. Some of the aspects that SMAS tracks are volume storage, CPU load, memory usage, the healthiness of endpoints, and error logs.</p>
